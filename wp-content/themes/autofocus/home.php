...
<?php while ( have_posts() ) : the_post() ?>
      	...
      	<div class="entry-date bigdate"><abbr class="published" title="View full version"><?php
          foreach((get_the_category()) as $category) {
            echo $category->cat_name . ' ';
        } ?></abbr></div>
      	<h2 class="entry-title post-content-title"><a href="<?php the_permalink() ?>" title="<?php printf( __('View full version of %s', 'sandbox'), the_title_attribute('echo=0') ) ?>" rel="bookmark"><span><?php the_title() ?></span></a></h2>
